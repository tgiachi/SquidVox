...
public class ImGuiRenderer : IDisposable
{
    ...
    /// <summary>
    ///     Creates a pointer to a texture, which can be passed through ImGui calls such as <see cref="ImGui.Image" />. That pointer
    ///     is then used by ImGui to let us know what texture to draw
    /// </summary>
    ...
    /// <summary>
    ///     Asks ImGui for the generated geometry data and sends it to the graphics pipeline, should be called after the UI is drawn
    ///     using ImGui.** calls
    /// </summary>
